...
export class Backend implements backendInterface {
    ...
    async getAllProductsByCategory(arg0: string): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: Array<OrderItem>): Promise<bigint | null> {
        if (this.processError) {
            try {
    ...
    async resetAndClaimAdmin(): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: string, arg5: string, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
